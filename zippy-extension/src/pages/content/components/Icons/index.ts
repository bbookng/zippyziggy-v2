export { default as BookmarkCategoryIcon } from './BookmarkCategoryIcon';
export { default as SearchIcon } from './SearchIcon';
export { default as BraveIcon } from './browser/BraveIcon';
export { default as ChromeIcon } from './browser/ChromeIcon';
export { default as EdgeIcon } from './browser/EdgeIcon';
export { default as SafariIcon } from './browser/SafariIcon';
export { default as UnknownIcon } from './browser/UnknownIcon';
export { default as WhaleIcon } from './browser/WhaleIcon';
export { default as GoogleIcon } from './modal-social/GoogleIcon';
export { default as KakaoIcon } from './modal-social/KakaoIcon';
export { default as LeftArrowIcon } from './pagination/LeftArrowIcon';
export { default as LeftDoubleArrowIcon } from './pagination/LeftDoubleArrowIcon';
export { default as RightArrowIcon } from './pagination/RightArrowIcon';
export { default as RightDoubleArrowIcon } from './pagination/RightDoubleArrowIcon';

export const TOP_ARROW = `<svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="h-4 w-4 m-1" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg" style="transform: scale(1, -1);">
  <line x1="12" y1="5" x2="12" y2="19"></line>
  <polyline points="19 12 12 19 5 12"></polyline>
</svg>`;

export const SHARE_MOBILE_SVG = `
...
export const SHARE_DESKTOP_SVG = `<svg width="1rem" height="1rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
      fill-rule="evenodd"
      clip-rule="evenodd"
      d="M1 18.5088C1 13.1679 4.90169 8.77098 9.99995 7.84598V5.51119C9.99995 3.63887
